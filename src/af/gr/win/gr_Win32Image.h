...
//pascal	virtual bool		convertToBuffer(UT_ByteBuf** ppBB) const;
//pascal	virtual bool		convertFromBuffer(const UT_ByteBuf* pBB, const std::string& mimetype, UT_sint32 iDisplayWidth, UT_sint32 iDisplayHeight);
